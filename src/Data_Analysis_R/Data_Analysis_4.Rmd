...
knitr::kable(non_coeluting_isomer_pairs %>% group_by(method, IM_precursor_pp_resolution <0.58) %>% summarise(n_distinct(isomer_pair)))


knitr::kable(non_coeluting_isomer_pairs %>% group_by(IM_precursor_pp_resolution <1) %>% summarise(n_distinct(isomer_pair)))
knitr::kable(non_coeluting_isomer_pairs %>% group_by(IM_precursor_pp_resolution <0.58) %>% summarise(n_distinct(isomer_pair)))
